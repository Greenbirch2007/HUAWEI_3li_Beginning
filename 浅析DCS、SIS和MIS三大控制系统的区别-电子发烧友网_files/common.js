...
<div class="sub_dis_wrap">\
    ...
    <ul class="disList">\
        ...
        <li><a href="http://z.elecfans.com/" target="_blank">华秋众筹</a></li>\
...
<div class="sub_dis_wrap">\
    <h3 class="disTitle"><a href="http://www.hqpcb.com/" target="_blank">华秋PCB</a></h3>\
    <ul class="disList" style="margin-right: 0;">\
...
<div class="sub_dis_wrap" style="border-right: 0;">\
    <h3 class="disTitle"><a href="http://www.hqchip.com/" target="_blank">华秋芯城</a></h3>\
    <ul class="disList">\
...
var html = '<div style="width: 960px;height: 40px;line-height: 40px;background: linear-gradient(to right, #5ec1aa, #508ca8);margin: 0 auto 12px;font-size: 16px;padding: 0 20px;">'+
        '<a href="http://z.elecfans.com/280.html?elecfans_trackid=elecfans_articletop" target="_blank" style="display: inline-block;width: 95%;text-align:center;color: #fff;">史上最完整运放5部（基础理论+典型应用+综合项目）众筹视频，带你吃透模电工程师职场核心技能！<span style="margin-left:2em;">👉戳此立抢👈</span></a>'+
        '<span style="float: right;color: #fff;cursor: pointer;" onclick="(this.parentNode.remove())">✕</span>'+
    '</div>';
...
var banner_ad_htm = '<div class="banner_ad201905">'+
    ...
    '<div style="width: 1000px;margin: 0 auto;position: relative;">'+
        '<a href="https://data.hqchip.com:4006/t/x5" target="_blank">'+
            '<img src="/skin-2012/images/banner_ad201905.png?20190701" style="width:675px;height: 90px;"/>'+
        '</a>'+
